...
cat("\\markright{",
    paste0(
      ...
      "Erstellt am: ", as.Date(certificate$createdAt), "\\\\"
    ),
    "}")
...
metadata_to_show_latex <- paste0(
      ...
      "\\textbf{Aufnahmedatum:} ", as.POSIXct(metadata$dateTime, format="%Y-%m-%dT%H:%M:%S"), "\\\\",
      "\\textbf{Kamera:} ", metadata$make, " ", metadata$model, "\\\\",
      "\\textbf{Auflösung:} ", metadata$imageWidth, " x ", metadata$imageHeight, " Pixel\\\\",
      "\\textbf{Software:} ", metadata$software, "\\\\",
